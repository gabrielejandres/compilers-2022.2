...
static const yytype_int8 yytranslate[] =
{
      ...
      32,    36,    28,    26,    37,    27,    33,    29,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,    25,    40,
      42,    23,    41,    24,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
static const yytype_int16 yyrline[] =
{
     ...
     131,   132,   133,   134,   140,   148,   149,   150,   153,   156,
     162,   170,   176,   184,   189,   194,   201,   204,   207,   210,
     213,   214,   215,   218,   219,   220,   224,   225,   228,   229,
     230,   233,   234,   237,   238,   241,   242,   243,   244,   247,
     248,   249,   252,   255,   256,   259,   260,   263,   264,   267,
     268,   271,   272,   275,   278,   279,   282,   283,   286,   287,
     288,   291,   292,   293,   294,   295,   298,   299,   300,   301,
     302,   303,   304,   305,   308,   309,   310,   313,   314,   315,
...
static const char *const yytname[] =
{
  ...
  "WHILE", "FOR", "FUNCTION", "ASM", "RETURN", "BLOCO", "'='", "'?'",
  "':'", "'+'", "'-'", "'*'", "'/'", "'%'", "'T'", "'('", "'.'", "'{'",
  "'}'", "')'", "','", "'['", "']'", "';'", "'>'", "'<'", "$accept", "s",
  "cmds", "cmd_1", "cmd_2", "bloco", "funcao", "args", "arg",
...
static const yytype_int16 yytoknum[] =
{
     ...
     275,   276,   277,    61,    63,    58,    43,    45,    42,    47,
      37,    84,    40,    46,   123,   125,    41,    44,    91,    93,
      59,    62,    60
};
# endif
...
{
     218,  -119,   179,     8,     8,     8,  -119,  -119,  -119,    -8,
      -5,     6,    50,   107,  -119,    30,   107,  -119,    70,  -119,
    -119,   218,  -119,  -119,  -119,  -119,  -119,  -119,  -119,  -119,
    -119,  -119,   332,  -119,   107,  -119,   270,    59,   285,    -3,
    -119,  -119,  -119,   107,   107,   104,  -119,     3,   107,   133,
    -119,   413,   218,  -119,   164,  -119,  -119,   107,   107,   107,
     107,   107,   107,   107,    53,   171,    46,  -119,   133,    18,
      29,    38,   382,   107,     8,  -119,    45,   315,    56,     8,
      42,    66,  -119,    97,   424,    71,    68,  -119,  -119,    36,
      36,    86,    86,    86,   389,    84,   366,   296,   270,   107,
     107,   107,    99,   401,  -119,  -119,   107,   107,   107,   107,
     250,    83,   107,   184,  -119,  -119,   121,  -119,   107,  -119,
      89,    64,  -119,  -119,    63,  -119,   345,  -119,   133,   374,
     171,   133,   107,  -119,   250,   133,   133,   133,   133,   218,
      88,  -119,  -119,   107,    93,   228,   250,   -19,  -119,   133,
     100,   112,  -119,  -119,  -119,   285,  -119,   137,   137,   296,
    -119,   133,  -119,   102,  -119,   108,   285,   107,  -119,   250,
     305,   107,   352,    89,   119,  -119,  -119,   136,  -119,   285,
     114,   133,  -119,  -119,  -119,  -119,   133,  -119,   115,   250,
    -119,   250,   250,  -119,  -119,  -119,  -119
};
...
{
       5,    88,    87,     0,     0,     0,    91,    92,    93,     0,
       0,     0,     0,    13,    95,     0,     0,    28,     0,     2,
      62,     5,    17,    16,     6,    30,    31,    32,    10,    59,
      60,    15,    12,    82,     0,    94,     0,     0,     0,    58,
       7,     8,     9,     0,     0,     0,    28,    87,     0,    14,
      89,     0,     5,     1,     5,     4,    11,     0,     0,     0,
       0,     0,    86,     0,     0,    35,    87,    34,    33,    81,
       0,     0,     0,     0,     0,    56,     0,    75,     0,     0,
       0,     0,    26,     0,     0,    90,     0,    61,     3,    76,
      77,    78,    79,    80,    85,     0,     0,     0,     0,     0,
       0,     0,     0,    58,    57,    28,     0,     0,     0,     0,
       0,     0,     0,     0,    81,    90,     0,    29,    86,    83,
      54,    87,    48,    43,    46,    49,    45,    37,    36,     0,
      39,    38,     0,    55,     0,    73,    74,    71,    72,     5,
       0,    70,    63,     0,     0,    87,     0,     0,    22,    25,
      41,     0,    18,    84,    53,     0,    52,     0,     0,     0,
      42,    44,    29,     0,    69,     0,     0,     0,    29,     0,
       0,     0,     0,     0,    51,    50,    47,    67,    68,     0,
       0,    24,    20,    27,    29,    21,    40,    28,     0,     0,
      19,     0,     0,    65,    29,    64,    66
};
...
{
    -119,  -119,   -15,     1,     5,  -119,  -119,  -119,   -18,  -119,
     -29,   -44,  -104,   -34,  -119,    58,  -119,    48,   -87,    16,
    -115,  -119,  -106,     4,    74,  -119,  -119,  -119,  -119,  -119,
    -118,   -37,   -13,    60,  -119
};
...
{
      -1,    18,    19,   140,   141,    22,    23,   147,   148,    81,
     182,    52,   183,    24,    25,    67,    26,    70,    27,   123,
     124,   125,    64,    40,    75,    28,    54,    29,    30,    31,
     142,    76,    32,    95,    33
};
...
{
      49,    20,    82,    51,    71,    21,    55,    78,    41,    42,
     122,    80,    39,   152,   154,   156,   162,   169,   170,    35,
      73,    65,    20,    68,    43,    72,    21,    44,   168,   -41,
      77,    77,    72,    50,    74,    84,    83,    86,    45,    88,
     100,   -41,   174,   175,    89,    90,    91,    92,    93,    94,
      96,   184,   101,    20,    46,    20,    99,    21,   177,    21,
     103,   134,    35,    69,    59,    60,    61,   156,    62,    98,
      53,   193,   122,   194,   195,   144,    97,   102,   104,    83,
      35,   105,   112,   111,   126,   128,   129,   130,   131,   157,
     196,   158,   110,   135,   136,   137,   138,    83,   113,    77,
     149,   114,   155,   117,   116,    94,   165,     1,     2,    79,
       1,    47,     6,     7,     8,     6,     7,     8,    62,   161,
     119,    71,   132,   143,   163,   150,    14,    63,   164,    14,
      77,    15,   180,   166,    15,   171,    16,   178,    99,    48,
      20,   173,   172,   191,    21,   188,   126,   158,   179,   187,
     189,   192,   185,    72,   181,   190,   127,   149,   186,    57,
      58,    59,    60,    61,   151,    62,    72,     1,     2,     3,
       4,     5,     6,     7,     8,   176,     9,   133,   153,     0,
       0,    10,    11,    12,     0,    13,    14,     1,   145,     0,
      34,    15,     6,     7,     8,    35,    16,    57,    17,    59,
      60,    61,    36,    62,    87,     0,    14,     0,     0,     0,
       0,    15,    37,     0,     0,     0,    48,    38,     0,     0,
     146,     1,     2,     3,     4,     5,     6,     7,     8,     0,
       9,     0,     0,     0,     0,    10,    11,    12,     0,    13,
      14,     0,     0,     0,    35,    15,     0,     0,     0,     0,
      16,   167,    17,     1,     2,     3,     4,     5,     6,     7,
       8,    83,     9,     0,   -23,   -23,     0,    10,    11,    12,
       0,    13,    14,     1,    66,     0,     0,    15,     6,     7,
       8,     0,    16,     0,   139,     0,     0,     0,     1,     2,
       0,     0,    14,     6,     7,     8,     0,    15,     0,     1,
     121,     0,    48,     0,     6,     7,     8,    14,     1,   145,
       0,     0,    15,     6,     7,     8,     0,    16,    14,     0,
       0,     0,     0,    15,     0,     0,     0,    14,    48,   106,
     107,     0,    15,     0,     0,     0,     0,    48,     0,     0,
       0,    57,    58,    59,    60,    61,     0,    62,     0,     0,
       0,     0,    56,     0,     0,     0,   108,   109,    57,    58,
      59,    60,    61,     0,    62,     0,     0,     0,   159,     0,
      63,    57,    58,    59,    60,    61,     0,    62,    57,    58,
      59,    60,    61,    63,    62,     0,     0,     0,     0,     0,
      63,   120,    57,    58,    59,    60,    61,     0,    62,     0,
      57,    58,    59,    60,    61,   120,    62,     0,    57,    58,
      59,    60,    61,   160,    62,    57,    58,    59,    60,    61,
      63,    62,     0,     0,     0,     0,   118,    57,    58,    59,
      60,    61,     0,    62,     0,     0,     0,     0,    74,    57,
      58,    59,    60,    61,     0,    62,     0,     0,     0,    85,
...
{
      13,     0,    46,    16,    38,     0,    21,    44,     4,     5,
      97,    45,     4,   117,   120,   121,   134,    36,    37,    16,
      23,    34,    21,    36,    32,    38,    21,    32,   146,    11,
      43,    44,    45,     3,    37,    48,    33,    52,    32,    54,
      11,    23,   157,   158,    57,    58,    59,    60,    61,    62,
      63,   169,    23,    52,     4,    54,    38,    52,   162,    54,
      73,   105,    16,     4,    28,    29,    30,   173,    32,    23,
       0,   189,   159,   191,   192,   112,    23,    39,    74,    33,
      16,    36,    40,    79,    97,    98,    99,   100,   101,    26,
     194,    28,    36,   106,   107,   108,   109,    33,    32,   112,
     113,     4,    38,    35,    33,   118,   143,     3,     4,     5,
       3,     4,     8,     9,    10,     8,     9,    10,    32,   132,
      36,   155,    23,    40,   139,     4,    22,    38,    40,    22,
     143,    27,   166,    40,    27,    23,    32,    35,    38,    32,
     139,     4,   155,   187,   139,   179,   159,    28,    40,    13,
      36,    36,   170,   166,   167,   184,    98,   170,   171,    26,
      27,    28,    29,    30,   116,    32,   179,     3,     4,     5,
       6,     7,     8,     9,    10,   159,    12,   103,   118,    -1,
      -1,    17,    18,    19,    -1,    21,    22,     3,     4,    -1,
      11,    27,     8,     9,    10,    16,    32,    26,    34,    28,
      29,    30,    23,    32,    40,    -1,    22,    -1,    -1,    -1,
      -1,    27,    33,    -1,    -1,    -1,    32,    38,    -1,    -1,
      36,     3,     4,     5,     6,     7,     8,     9,    10,    -1,
      12,    -1,    -1,    -1,    -1,    17,    18,    19,    -1,    21,
      22,    -1,    -1,    -1,    16,    27,    -1,    -1,    -1,    -1,
      32,    23,    34,     3,     4,     5,     6,     7,     8,     9,
      10,    33,    12,    -1,    36,    37,    -1,    17,    18,    19,
      -1,    21,    22,     3,     4,    -1,    -1,    27,     8,     9,
      10,    -1,    32,    -1,    34,    -1,    -1,    -1,     3,     4,
      -1,    -1,    22,     8,     9,    10,    -1,    27,    -1,     3,
       4,    -1,    32,    -1,     8,     9,    10,    22,     3,     4,
      -1,    -1,    27,     8,     9,    10,    -1,    32,    22,    -1,
      -1,    -1,    -1,    27,    -1,    -1,    -1,    22,    32,    14,
      15,    -1,    27,    -1,    -1,    -1,    -1,    32,    -1,    -1,
      -1,    26,    27,    28,    29,    30,    -1,    32,    -1,    -1,
      -1,    -1,    20,    -1,    -1,    -1,    41,    42,    26,    27,
      28,    29,    30,    -1,    32,    -1,    -1,    -1,    23,    -1,
      38,    26,    27,    28,    29,    30,    -1,    32,    26,    27,
      28,    29,    30,    38,    32,    -1,    -1,    -1,    -1,    -1,
      38,    39,    26,    27,    28,    29,    30,    -1,    32,    -1,
      26,    27,    28,    29,    30,    39,    32,    -1,    26,    27,
      28,    29,    30,    39,    32,    26,    27,    28,    29,    30,
      38,    32,    -1,    -1,    -1,    -1,    37,    26,    27,    28,
      29,    30,    -1,    32,    -1,    -1,    -1,    -1,    37,    26,
...
static const yytype_int8 yystos[] =
{
      ...
      17,    18,    19,    21,    22,    27,    32,    34,    44,    45,
      46,    47,    48,    49,    56,    57,    59,    61,    68,    70,
      71,    72,    75,    77,    11,    16,    23,    33,    38,     4,
      66,    66,    66,    32,    32,    32,     4,     4,    32,    75,
       3,    75,    54,     0,    69,    45,    20,    26,    27,    28,
      29,    30,    32,    38,    65,    75,     4,    58,    75,     4,
      60,    56,    75,    23,    37,    67,    74,    75,    74,     5,
      56,    52,    54,    33,    75,    36,    45,    40,    45,    75,
      75,    75,    75,    75,    75,    76,    75,    23,    23,    38,
      11,    23,    39,    75,    66,    36,    14,    15,    41,    42,
      36,    66,    40,    32,     4,    36,    33,    35,    37,    36,
      39,     4,    61,    62,    63,    64,    75,    58,    75,    75,
      75,    75,    23,    67,    54,    75,    75,    75,    75,    34,
      46,    47,    73,    40,    74,     4,    36,    50,    51,    75,
       4,    60,    55,    76,    65,    38,    65,    26,    28,    23,
      39,    75,    73,    45,    40,    74,    40,    23,    73,    36,
      37,    23,    75,     4,    63,    63,    62,    55,    35,    40,
      56,    75,    53,    55,    73,    51,    75,    13,    56,    36,
      53,    54,    36,    73,    73,    73,    55
};
...
#line 1928 "y.tab.c"
  ...
  case 33:
#line 218 "mini_js.y"
                              { if(!eh_escopo) verifica_variaveis_declaradas(yyvsp[-2].v); print_prod("atr_id -> ID = exp"); yyval.c = to_vector(yyvsp[-2].v) + yyvsp[0].c + "="; }
#line 1934 "y.tab.c"
    break;

  case 34:
#line 219 "mini_js.y"
                              { if(!eh_escopo) verifica_variaveis_declaradas(yyvsp[-2].v); print_prod("atr_id -> ID = atr_recursiva"); yyval.c = to_vector(yyvsp[-2].v) + yyvsp[0].c + "="; }
#line 1940 "y.tab.c"
    break;

  case 35:
#line 220 "mini_js.y"
                              { if(!eh_escopo) verifica_variaveis_declaradas(yyvsp[-2].v); print_prod("atr_id -> ID ADD exp_id"); yyval.c = to_vector(yyvsp[-2].v) + to_vector(yyvsp[-2].v) + "@" + yyvsp[0].c + "+" + "="; }
#line 1946 "y.tab.c"
    break;
...
#line 1988 "y.tab.c"
  ...
  case 43:
#line 237 "mini_js.y"
                                   { if(!eh_escopo) verifica_variaveis_declaradas(yyvsp[-3].v); print_prod("atr_array -> ID indices = exp"); yyval.c = yyvsp[-3].c + yyvsp[-2].c + yyvsp[0].c + "[=]"; }
#line 1994 "y.tab.c"
    break;

  case 44:
#line 238 "mini_js.y"
                                  { if(!eh_escopo) verifica_variaveis_declaradas(yyvsp[-5].v); print_prod("atr_array -> ID [ atr ] = exp"); yyval.c = to_vector(yyvsp[-5].v) + "@" + yyvsp[-3].c + yyvsp[0].c + "[=]"; }
#line 2000 "y.tab.c"
    break;
