...
static const yytype_int8 yytranslate[] =
{
      ...
      33,    37,    29,    27,    38,    28,    34,    30,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,    26,    41,
      43,    24,    42,    25,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
static const yytype_int16 yyrline[] =
{
     ...
     247,   248,   251,   254,   255,   258,   268,   271,   272,   275,
     276,   279,   280,   283,   286,   287,   290,   291,   294,   295,
     296,   299,   300,   301,   302,   303,   306,   307,   308,   309,
     310,   311,   312,   313,   320,   321,   322,   325,   326,   327,
...
static const char *const yytname[] =
{
  ...
  "'='", "'?'", "':'", "'+'", "'-'", "'*'", "'/'", "'%'", "'T'", "'('",
  "'.'", "'{'", "'}'", "')'", "','", "'['", "']'", "';'", "'>'", "'<'",
  "$accept", "s", "cmds", "cmd_1", "cmd_2", "bloco", "funcao", "args",
  "arg", "empilha_escopo_func", "desempilha_escopo_func", "empilha_escopo",
...
static const yytype_int16 yytoknum[] =
{
     ...
     275,   276,   277,   278,    61,    63,    58,    43,    45,    42,
      47,    37,    84,    40,    46,   123,   125,    41,    44,    91,
      93,    59,    62,    60
};
# endif
...
{
     204,  -118,    91,     7,     7,     7,  -118,  -118,  -118,    21,
      23,    26,    16,   274,  -118,  -118,    71,   274,  -118,    42,
    -118,  -118,   204,  -118,  -118,  -118,  -118,  -118,  -118,  -118,
    -118,  -118,  -118,   365,  -118,   274,  -118,   290,    76,   306,
      17,  -118,  -118,  -118,   274,   274,   258,  -118,     9,   274,
     133,  -118,   446,   204,  -118,   165,  -118,  -118,   274,   274,
     274,   274,   274,   274,   274,    58,   353,    47,  -118,   133,
      -1,    33,    43,   415,   274,     7,  -118,    53,   348,    54,
       7,    51,    60,  -118,    94,   457,    69,    73,  -118,  -118,
      39,    39,    72,    72,    72,   422,    74,   399,   322,   290,
     274,   274,   274,    86,   434,  -118,  -118,   274,   274,   274,
     274,   237,    78,   274,   113,  -118,  -118,   108,  -118,   274,
    -118,    75,     1,  -118,  -118,    -8,  -118,   378,  -118,   133,
     407,   353,   133,   274,  -118,   237,   133,   133,   133,   133,
     204,    85,  -118,  -118,   274,    87,   181,   237,   -22,  -118,
     133,    88,    89,  -118,  -118,  -118,   306,  -118,   128,   128,
     322,  -118,   133,  -118,    97,  -118,    93,   306,   274,  -118,
     237,   338,   274,   385,    75,   109,  -118,  -118,   124,  -118,
     306,   102,   133,  -118,  -118,  -118,  -118,   133,  -118,   103,
     237,  -118,   237,   237,  -118,  -118,  -118,  -118
};
...
static const yytype_int8 yydefact[] =
{
       ...
       0,     0,     0,    13,    95,    96,     0,     0,    28,     0,
       2,    62,     5,    17,    16,     6,    30,    31,    32,    10,
      59,    60,    15,    12,    82,     0,    94,     0,     0,     0,
      58,     7,     8,     9,     0,     0,     0,    28,    87,     0,
      14,    89,     0,     5,     1,     5,     4,    11,     0,     0,
       0,     0,     0,    86,     0,     0,    35,    87,    34,    33,
      81,     0,     0,     0,     0,     0,    56,     0,    75,     0,
       0,     0,     0,    26,     0,     0,    90,     0,    61,     3,
      76,    77,    78,    79,    80,    85,     0,     0,     0,     0,
       0,     0,     0,     0,    58,    57,    28,     0,     0,     0,
       0,     0,     0,     0,     0,    81,    90,     0,    29,    86,
      83,    54,    87,    48,    43,    46,    49,    45,    37,    36,
       0,    39,    38,     0,    55,     0,    73,    74,    71,    72,
       5,     0,    70,    63,     0,     0,    87,     0,     0,    22,
      25,    41,     0,    18,    84,    53,     0,    52,     0,     0,
       0,    42,    44,    29,     0,    69,     0,     0,     0,    29,
       0,     0,     0,     0,     0,    51,    50,    47,    67,    68,
       0,     0,    24,    20,    27,    29,    21,    40,    28,     0,
       0,    19,     0,     0,    65,    29,    64,    66
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
    -118,  -118,   -16,     5,    12,  -118,  -118,  -118,   -23,  -118,
     -34,   -44,  -111,   -38,  -118,    50,  -118,    36,   -96,    -4,
     -80,  -118,  -108,    24,    61,  -118,  -118,  -118,  -118,  -118,
    -117,   -36,   -13,    38,  -118
};
...
{
      -1,    19,    20,   141,   142,    23,    24,   148,   149,    82,
     183,    53,   184,    25,    26,    68,    27,    71,    28,   124,
     125,   126,    65,    41,    76,    29,    55,    30,    31,    32,
     143,    77,    33,    96,    34
};
...
{
      50,    72,   123,    83,    52,    21,    56,   153,    81,    79,
     -41,    40,    22,   155,   157,   170,   171,    36,   163,   158,
      47,   159,    66,   -41,    69,    36,    73,    21,    42,    43,
     169,    78,    78,    73,    22,    84,    85,    87,   100,    89,
     156,    74,    54,    84,   101,    90,    91,    92,    93,    94,
      95,    97,   178,   185,    44,    75,    45,   102,    21,    46,
      21,   104,   135,    36,   123,    22,   157,    22,    60,    61,
      62,    99,    63,   194,    51,   195,   196,   145,   175,   176,
      70,    84,    98,   103,   197,   127,   129,   130,   131,   132,
     106,   111,   113,   114,   136,   137,   138,   139,   115,   105,
      78,   150,    35,   117,   112,    63,    95,    36,   166,   118,
     133,   120,   151,   172,    64,    37,     1,   146,    72,   144,
     162,     6,     7,     8,   164,    38,   165,   100,   167,   181,
      39,    78,   174,   179,   180,    14,    15,   188,   159,   190,
     193,    16,   189,   173,   192,    21,    49,   127,   186,   128,
     147,   191,    22,   152,    73,   182,   177,   154,   150,   187,
      58,    59,    60,    61,    62,   134,    63,    73,     1,     2,
       3,     4,     5,     6,     7,     8,     0,     9,     0,     0,
       0,     0,    10,    11,    12,     0,    13,    14,    15,     0,
       0,     0,     0,    16,     0,     0,     0,    36,    17,     0,
      18,     0,     0,     0,     0,   168,    88,     1,     2,     3,
       4,     5,     6,     7,     8,    84,     9,     0,   -23,   -23,
       0,    10,    11,    12,     0,    13,    14,    15,     0,     0,
       0,     0,    16,     0,     0,     0,     0,    17,     0,    18,
       1,     2,     3,     4,     5,     6,     7,     8,     0,     9,
       0,     0,     0,     0,    10,    11,    12,     0,    13,    14,
      15,     1,     2,    80,     0,    16,     6,     7,     8,     0,
      17,     0,   140,     0,     0,     0,     0,     1,    48,     0,
      14,    15,     6,     7,     8,     0,    16,     0,     0,     0,
       0,    17,     0,     1,    67,     0,    14,    15,     6,     7,
       8,     0,    16,     0,     0,     0,     0,    49,     0,     1,
       2,     0,    14,    15,     6,     7,     8,     0,    16,     0,
       0,     0,     0,    49,     0,     1,   122,     0,    14,    15,
       6,     7,     8,     0,    16,     0,     0,     0,     0,    17,
       0,     1,   146,     0,    14,    15,     6,     7,     8,     0,
      16,     0,     0,     0,     0,    49,     0,     0,     0,     0,
      14,    15,   107,   108,     0,     0,    16,     0,     0,     0,
       0,    49,     0,     0,     0,    58,    59,    60,    61,    62,
      58,    63,    60,    61,    62,    57,    63,     0,     0,     0,
     109,   110,    58,    59,    60,    61,    62,     0,    63,     0,
       0,     0,   160,     0,    64,    58,    59,    60,    61,    62,
       0,    63,    58,    59,    60,    61,    62,    64,    63,     0,
       0,     0,     0,     0,    64,   121,    58,    59,    60,    61,
      62,     0,    63,     0,    58,    59,    60,    61,    62,   121,
      63,     0,    58,    59,    60,    61,    62,   161,    63,    58,
      59,    60,    61,    62,    64,    63,     0,     0,     0,     0,
     119,    58,    59,    60,    61,    62,     0,    63,     0,     0,
       0,     0,    75,    58,    59,    60,    61,    62,     0,    63,
       0,     0,     0,    86,    58,    59,    60,    61,    62,     0,
      63,     0,     0,     0,   116
};

static const yytype_int16 yycheck[] =
{
      13,    39,    98,    47,    17,     0,    22,   118,    46,    45,
      11,     4,     0,   121,   122,    37,    38,    16,   135,    27,
       4,    29,    35,    24,    37,    16,    39,    22,     4,     5,
     147,    44,    45,    46,    22,    34,    49,    53,    39,    55,
      39,    24,     0,    34,    11,    58,    59,    60,    61,    62,
      63,    64,   163,   170,    33,    38,    33,    24,    53,    33,
      55,    74,   106,    16,   160,    53,   174,    55,    29,    30,
      31,    24,    33,   190,     3,   192,   193,   113,   158,   159,
       4,    34,    24,    40,   195,    98,    99,   100,   101,   102,
      37,    37,    41,    33,   107,   108,   109,   110,     4,    75,
     113,   114,    11,    34,    80,    33,   119,    16,   144,    36,
      24,    37,     4,    24,    39,    24,     3,     4,   156,    41,
     133,     8,     9,    10,   140,    34,    41,    39,    41,   167,
      39,   144,     4,    36,    41,    22,    23,    13,    29,    37,
      37,    28,   180,   156,   188,   140,    33,   160,   171,    99,
      37,   185,   140,   117,   167,   168,   160,   119,   171,   172,
      27,    28,    29,    30,    31,   104,    33,   180,     3,     4,
       5,     6,     7,     8,     9,    10,    -1,    12,    -1,    -1,
      -1,    -1,    17,    18,    19,    -1,    21,    22,    23,    -1,
      -1,    -1,    -1,    28,    -1,    -1,    -1,    16,    33,    -1,
      35,    -1,    -1,    -1,    -1,    24,    41,     3,     4,     5,
       6,     7,     8,     9,    10,    34,    12,    -1,    37,    38,
      -1,    17,    18,    19,    -1,    21,    22,    23,    -1,    -1,
      -1,    -1,    28,    -1,    -1,    -1,    -1,    33,    -1,    35,
       3,     4,     5,     6,     7,     8,     9,    10,    -1,    12,
      -1,    -1,    -1,    -1,    17,    18,    19,    -1,    21,    22,
      23,     3,     4,     5,    -1,    28,     8,     9,    10,    -1,
      33,    -1,    35,    -1,    -1,    -1,    -1,     3,     4,    -1,
      22,    23,     8,     9,    10,    -1,    28,    -1,    -1,    -1,
      -1,    33,    -1,     3,     4,    -1,    22,    23,     8,     9,
      10,    -1,    28,    -1,    -1,    -1,    -1,    33,    -1,     3,
       4,    -1,    22,    23,     8,     9,    10,    -1,    28,    -1,
      -1,    -1,    -1,    33,    -1,     3,     4,    -1,    22,    23,
       8,     9,    10,    -1,    28,    -1,    -1,    -1,    -1,    33,
      -1,     3,     4,    -1,    22,    23,     8,     9,    10,    -1,
      28,    -1,    -1,    -1,    -1,    33,    -1,    -1,    -1,    -1,
      22,    23,    14,    15,    -1,    -1,    28,    -1,    -1,    -1,
      -1,    33,    -1,    -1,    -1,    27,    28,    29,    30,    31,
      27,    33,    29,    30,    31,    20,    33,    -1,    -1,    -1,
      42,    43,    27,    28,    29,    30,    31,    -1,    33,    -1,
      -1,    -1,    24,    -1,    39,    27,    28,    29,    30,    31,
      -1,    33,    27,    28,    29,    30,    31,    39,    33,    -1,
      -1,    -1,    -1,    -1,    39,    40,    27,    28,    29,    30,
      31,    -1,    33,    -1,    27,    28,    29,    30,    31,    40,
      33,    -1,    27,    28,    29,    30,    31,    40,    33,    27,
      28,    29,    30,    31,    39,    33,    -1,    -1,    -1,    -1,
      38,    27,    28,    29,    30,    31,    -1,    33,    -1,    -1,
      -1,    -1,    38,    27,    28,    29,    30,    31,    -1,    33,
      -1,    -1,    -1,    37,    27,    28,    29,    30,    31,    -1,
      33,    -1,    -1,    -1,    37
};
...
static const yytype_int8 yystos[] =
{
      ...
      17,    18,    19,    21,    22,    23,    28,    33,    35,    45,
      46,    47,    48,    49,    50,    57,    58,    60,    62,    69,
      71,    72,    73,    76,    78,    11,    16,    24,    34,    39,
       4,    67,    67,    67,    33,    33,    33,     4,     4,    33,
      76,     3,    76,    55,     0,    70,    46,    20,    27,    28,
      29,    30,    31,    33,    39,    66,    76,     4,    59,    76,
       4,    61,    57,    76,    24,    38,    68,    75,    76,    75,
       5,    57,    53,    55,    34,    76,    37,    46,    41,    46,
      76,    76,    76,    76,    76,    76,    77,    76,    24,    24,
      39,    11,    24,    40,    76,    67,    37,    14,    15,    42,
      43,    37,    67,    41,    33,     4,    37,    34,    36,    38,
      37,    40,     4,    62,    63,    64,    65,    76,    59,    76,
      76,    76,    76,    24,    68,    55,    76,    76,    76,    76,
      35,    47,    48,    74,    41,    75,     4,    37,    51,    52,
      76,     4,    61,    56,    77,    66,    39,    66,    27,    29,
      24,    40,    76,    74,    46,    41,    75,    41,    24,    74,
      37,    38,    24,    76,     4,    64,    64,    63,    56,    36,
      41,    57,    76,    54,    56,    74,    52,    76,    13,    57,
      37,    54,    55,    37,    74,    74,    74,    56
};
...
#line 1904 "y.tab.c"
  ...
  case 28:
#line 206 "mini_js.y"
                { print_prod("empilha_escopo -> "); eh_escopo = true; }
#line 1910 "y.tab.c"
    break;
...
#line 313 "mini_js.y"
                        { print_prod("exp -> exp ( params )"); 
                          if(fim_chamada && yyvsp[-3].v != "f") yyval.c = yyvsp[-1].c + to_string(n_params) + yyvsp[-3].v + "@" + "$" + "^";
                          else yyval.c = yyvsp[-1].c + to_string(n_params) + yyvsp[-3].v + "@" + "$"; 
                          n_params = 0;
                        }
#line 2253 "y.tab.c"
    break;
...
#line 2289 "y.tab.c"
  ...
  case 90:
#line 328 "mini_js.y"
                  { print_prod("val -> ( exp )"); yyval = yyvsp[-1]; yyval.c = yyvsp[-1].c; fim_chamada = true; }
#line 2295 "y.tab.c"
    break;
